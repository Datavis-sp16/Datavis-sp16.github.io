...
A number of sample datasets are built-in to many visualization tools.  You are encouraged to use one of these, however, you may also chose any other dataset you find. You should choose a subject (and data) you are intersted in.
...
formatting if needed. Pellentesque habitant morbi tristique senectus et netus et 
...
Gender discrepencies are well known to exist in blah bah. The figure shows how 
gender correlates with whatever.  As the graph shows, the more blah, the less 
blah blah.  This might be a longer paraphraph.  Lorem ipsum, etc.  
```
